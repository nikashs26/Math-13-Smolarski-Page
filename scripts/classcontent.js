...
expandAllButton.addEventListener('mouseover', (event) => {
    if (numTimesExpandToggleClicked % 2 == 0) {
        expandAllButton.style.borderImage = "url(../assets/borders/Plus_Border_Expand3.png) 20 round";
    } else {
        expandAllButton.style.borderImage = "url(../assets/borders/Minus_Border_Collapse3.png) 20 round";
    }
})

expandAllButton.addEventListener('mouseout', (event) => {
    if (numTimesExpandToggleClicked % 2 == 0) {
        expandAllButton.style.borderImage = "url(../assets/borders/Plus_Border_Expand.png) 20 round";
    } else {
        expandAllButton.style.borderImage = "url(../assets/borders/Minus_Border_Collapse.png) 20 round";
    }
})
